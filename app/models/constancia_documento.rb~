class ConstanciaDocumento < ApplicationRecord
  ...
  def self.options_for_unidad_academica
    [
      ...
      ['CENTRO UNIVERSITARIO GRUPO SOL, CAMPUS CUAUHTEMOC, CUGS CUAUH', 'CENTRO UNIVERSITARIO GRUPO SOL, CAMPUS CUAUHTEMOC'],	'INSTITUTO BRITANICO DE LA CIUDAD DE PUEBLA'],
      ['CENTRO UNIVERSITARIO GRUPO SOL, CEM, S.C. PLANTEL SANTO TOMAS, CUGS CEM ST',	
      ['CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL CHALCO, CUGS CHALCO', 'CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL CHALCO'],	'DIF DE ENFERMERIA, A.C.'],
      ['CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL SANTO TOMAS, CUGS ST', 'CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL SANTO TOMAS'],	
      ['DIF DE ENFERMERIA, A.C., DIF',	'UNIVERSIDAD ARKOS'],
      ['EBC', 'ESCUELA BANCARIA Y COMERCIAL'],	
      ['ESCUELA TECNOLOGICA DE ZUMPANGO, A.C., ET ZUMPANGO', 'ESCUELA TECNOLOGICA DE ZUMPANGO, A.C.'],	'UNIVERSIDAD ISEC, PLANTEL DEL VALLE'],
      ['ILB', 'CENTRO INSTITUTO LEONARDO BRAVO, A.C., PLANTEL CENTRO'],	
      ['ILBC', 'INSTITUTO LEONARDO BRAVO, A.C., PLANTEL CENTRO'],	
      ['INSTITUTO BRITANICO DE LA CIUDAD DE PUEBLA, IB PUEBLA',	
      ['INSTITUTO DE ENSEÑANZA SUPERIOR EN CONTADURIA Y ADMINISTRACION, S.C., IESCA',	
      ['INSTITUTO DE ESTUDIOS SUPERIORES "HIDALGO", IES HIDALGO','INSTITUTO DE ESTUDIOS SUPERIORES "HIDALGO"'],	'UNIVERSIDAD TECNOLOGICA INTERNACIONAL'],
      ...
      ['INSTITUTO LEONARDO BRAVO, A.C., PLANTEL LA RAZA, ILB LA RAZA',	'CENTRO UNIVERSITARIO GRUPO SOL, CEM, S.C. PLANTEL SANTO TOMAS'],
      ['INSTITUTO LEONARDO BRAVO, A.C., PLANTEL VERACRUZ, ILB VERACRUZ', 'INSTITUTO LEONARDO BRAVO, A.C., PLANTEL VERACRUZ'],	
      ['INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL IZTAPALAPA, IMEP STM', 'INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL IZTAPALAPA'],	
      ['INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL SANTA MARTHA, IMEP ZAR', 'INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL SANTA MARTHA'],	'INSTITUTO DE ENSEÑANZA SUPERIOR EN CONTADURIA Y ADMINISTRACION, S.C.'],
      ...
      ['UNIVERSIDAD TECNOLOGICA INTERNACIONAL, UTI',	'INSTITUTO LEONARDO BRAVO, A.C., PLANTEL LA RAZA'],
