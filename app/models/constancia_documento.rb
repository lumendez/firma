class ConstanciaDocumento < ApplicationRecord
  ...
  def self.options_for_unidad_academica
    [
      ...
      ['UPII ZACATECAS', 'UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS HIDALGO'],
      ['CICIMAR', 'CENTRO INTERDISCIPLINARIO DE CIENCIAS MARINAS'],
      ['UE ERNESTO PERALTA Q.',	'UNIDAD EDUCATIVA " ERNESTO PERALTA Q.", A.C.'],
      ['UPI', 'UNIVERSIDAD PRIVADA DE IRAPUATO'],
      ['CLAES', 'CENTRO LATINOAMERICANO DE ESTUDIOS SUPERIORES'],
      ['IB PUEBLA',	'INSTITUTO BRITANICO DE LA CIUDAD DE PUEBLA'],
      ['IES HIDALGO',	'INSTITUTO DE ESTUDIOS SUPERIORES "HIDALGO"'],
      ['DIF',	'DIF DE ENFERMERIA, A.C.'],
      ['ET ZUMPANGO', 'ESCUELA TECNOLOGICA DE ZUMPANGO, A.C.'],
      ['U ARKOS',	'UNIVERSIDAD ARKOS'],
      ['EBC', 'ESCUELA BANCARIA Y COMERCIAL'],
      ['ISEC DEL VALLE',	'UNIVERSIDAD ISEC, PLANTEL DEL VALLE'],
      ['CUGS CUAUH', 'CENTRO UNIVERSITARIO GRUPO SOL, CAMPUS CUAUHTEMOC'],
      ['ITESS', 'INSTITUTO TECNOLOGICO DE ESTUDIOS SUPERIORES DEL SURESTE, A.C.'],
      ['ILB', 'CENTRO	INSTITUTO LEONARDO BRAVO, A.C., PLANTEL CENTRO'],
      ['UTI',	'UNIVERSIDAD TECNOLOGICA INTERNACIONAL'],
      ['CES MARTINEZ DE LA TORRE', 'CENTRO DE ESTUDIOS SUPERIORES DE MARTINEZ DE LA TORRE, S.C.'],
      ['CUGS ST', 'CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL SANTO TOMAS'],
      ['CUGS CEM ST',	'CENTRO UNIVERSITARIO GRUPO SOL, CEM, S.C. PLANTEL SANTO TOMAS'],
      ['CUGS CHALCO', 'CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL CHALCO'],
      ['ITB SAN CARLOS', 'INSTITUTO TECNICO Y BANCARIO, "SAN CARLOS"'],
      ['IESCA',	'INSTITUTO DE ENSEÑANZA SUPERIOR EN CONTADURIA Y ADMINISTRACION, S.C.'],
      ['IECA GAUSS JORDAN', 'INSTITUTO ESPECIALIZADO EN COMPUTACION Y ADMINISTRACION "GAUSS JORDAN", A.C.'],
      ['UTM', 'UNIVERSIDAD TECNOLOGICA MESOAMERICANA, S.C.'],
      ['UTS COATZ', 'UNIVERSIDAD TECNOLOGICA DEL SURESTE, S.C., PLANTEL COATZACOALCOS'],
      ['UTS CAMPE', 'UNIVERSIDAD TECNOLOGICA DEL SURESTE, S.C., PLANTEL CAMPECHE'],
      ['UFLP', 'UNIVERSIDAD FRAY LUCA PACCIOLI'],
      ['CUD', 'CENTRO UNIVERSITARIO DORADOS'],
      ['UTCM CELAYA', 'UNIVERSIDAD TECNOLOGICA DEL CENTRO DE MEXICO, CAMPUS CELAYA'],
      ['ITSV', 'INSTITUTO DE TURISMO STUDIO VIAJES, A.C.'],
      ['IMEP STM', 'INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL IZTAPALAPA'],
      ['IMEP ZAR', 'INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL SANTA MARTHA'],
      ['ILB VERACRUZ', 'INSTITUTO LEONARDO BRAVO, A.C., PLANTEL VERACRUZ'],
      ['ITPP', 'INSTITUTO TECNICO PROFESIONAL PANAMERICANO'],
      ['CETUG', 'CENTRO DE ESTUDIOS TECNOLOGICOS Y UNIVERSITARIOS DEL GOLFO'],
      ['ILB LA RAZA',	'INSTITUTO LEONARDO BRAVO, A.C., PLANTEL LA RAZA'],
