class ConstanciaDocumento < ApplicationRecord
  ...
  def self.options_for_unidad_academica
    [
      ...
      ['UPII TLAXCALA',	'UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS TLAXCALA'],
      ['UPII PALENQUE',	'UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS PALENQUE'],
      ['UPII ZACATECAS', 'UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS ZACATECAS'],
      ['UPIEM', 'UNIDAD PROFESIONAL INTERDISCIPLINARIA DE ENERGIA Y MOVILIDAD'],
      ...
      ['CECyT 19 "LV"', 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 19 "LEONA VICARIO"'],
      ...
      ['CENTRO DE FORMACION Y APROVECHAMIENTO DEL RECURSO HUMANO, S.C., CAMPUS NEZAHUALCOYOTL, CEFARHU', 'CENTRO DE FORMACION Y APROVECHAMIENTO DEL RECURSO HUMANO, S.C., CAMPUS NEZAHUALCOYOTL'],
      ...
      ['INSTITUTO MEXICANO DE CERTIFICACION Y NORMAS', 'INSTITUTO MEXICANO DE CERTIFICACIÓN Y NORMAS, S.C.'],      	
      ...
      ['CENTRO DE ESTUDIOS SUPERIORES Y DE ESPECIALIDADES DEL ESTADO DE OAXACA', 'CENTRO DE ESTUDIOS SUPERIORES Y DE ESPECIALIDADES DEL ESTADO DE OAXACA']	
	]
  ...
  UNIDADES_ACADEMICAS = {
    # Escuelas Superiores de Ingeniería y Arquitectura
    "ESIATEC"      => "ESCUELA SUPERIOR DE INGENIERIA Y ARQUITECTURA, UNIDAD TECAMACHALCO",
    "ESIATIC"      => "ESCUELA SUPERIOR DE INGENIERIA Y ARQUITECTURA, UNIDAD TICOMAN",
    "ESIAZ"        => "ESCUELA SUPERIOR DE INGENIERIA Y ARQUITECTURA, UNIDAD ZACATENCO",
    # Escuelas Superiores de Ingeniería Mecánica y Eléctrica
    "ESIMEAZ"      => "ESCUELA SUPERIOR DE INGENIERIA MECANICA Y ELECTRICA, UNIDAD AZCAPOTZALCO",
    "ESIMECUL"     => "ESCUELA SUPERIOR DE INGENIERIA MECANICA Y ELECTRICA, UNIDAD CULHUACAN",
    "ESIMETIC"     => "ESCUELA SUPERIOR DE INGENIERIA MECANICA Y ELECTRICA, UNIDAD TICOMAN",
    "ESIMEZ"       => "ESCUELA SUPERIOR DE INGENIERIA MECANICA Y ELECTRICA, UNIDAD ZACATENCO",
    ...
    "ESE"          => "ESCUELA SUPERIOR DE ECONOMIA",
    "EST"          => "ESCUELA SUPERIOR DE TURISMO",
    # Escuelas Superiores de Comercio y Administración
    "ESCAUST"      => "ESCUELA SUPERIOR DE COMERCIO Y ADMINISTRACION, UNIDAD SANTO TOMAS",
    "ESCATEP"      => "ESCUELA SUPERIOR DE COMERCIO Y ADMINISTRACION, UNIDAD TEPEPAN",
    # Red ISISA
    "ISISAAZ"      => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - ESIME AZCAPOTZALCO",
    "ISISACUL"     => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - ESIME CULHUACAN",
    "ISISAESC"     => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - ESCOM",
    "ISISATIC"     => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - ESIME TICOMAN",
    "ISISAUPIICSA" => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - UPIICSA",
    "ISISAUPIIG"   => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - UPIIG",
    "ISISAUPIIH"   => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - UPIIH",
    "ISISAUPIITA"  => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - UPIITA",
    "ISISAZ"       => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - ESIME ZACATENCO",
    "ISISAUPIIT"    => "RED ACADEMICA DE INGENIERIA EN SISTEMAS AUTOMOTRICES (ISISA) - UPIIT",
    # Unidades Profesionales Interdisciplinarias
    "UPIIGTO"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS GUANAJUATO",
    "UPIIHDL"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS HIDALGO",
    "UPIIZAC"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS ZACATECAS",
    "UPIICOA"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS COAHUILA",
    "UPIITLA"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS TLAXCALA",
    "UPIIPAL"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA, CAMPUS PALENQUE",
    "UPIICSA"      => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE INGENIERIA Y CIENCIAS SOCIALES Y ADMINISTRATIVAS",
    "UPIITA"       => "UNIDAD PROFESIONAL INTERDISCIPLINARIA EN INGENIERIA Y TECNOLOGIAS AVANZADAS",
    "UPIBI"        => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE BIOTECNOLOGIA",
    "UPIEM"        => "UNIDAD PROFESIONAL INTERDISCIPLINARIA DE ENERGIA Y MOVILIDAD",
    # Centros Interdisciplinarios de Ciencias de la Salud
    "CICSUMA"      => "CENTRO INTERDISCIPLINARIO DE CIENCIAS DE LA SALUD, UNIDAD MILPA ALTA",
    "CICSUST"      => "CENTRO INTERDISCIPLINARIO DE CIENCIAS DE LA SALUD, UNIDAD SANTO TOMAS",
    # Escuelas Nacionales
    "ENCB"         => "ESCUELA NACIONAL DE CIENCIAS BIOLOGICAS",
    "ENMH"         => "ESCUELA NACIONAL DE MEDICINA Y HOMEOPATIA",
    "ENBA"         => "ESCUELA NACIONAL DE BIBLIOTECONOMIA Y ARCHIVONOMIA",
    ...
    "CECyT3"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 3 "ESTANISLAO RAMIREZ RUIZ"',
    "CECyT4"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 4 "LAZARO CARDENAS DEL RIO"',
    "CECyT5"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 5 "BENITO JUAREZ GARCIA"',
    "CECyT6"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 6 "MIGUEL OTHON DE MENDIZABAL"',
    "CECyT7"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 7 "CUAUHTEMOC"',
    "CECyT8"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 8 "NARCISO BASSOLS GARCIA"',
    "CECyT9"       => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 9 "JUAN DE DIOS BATIZ PAREDES"',
    "CECyT10"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 10 "CARLOS VALLEJO MARQUEZ"',
    "CECyT11"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 11 "WILFRIDO MASSIEU PEREZ"',
    "CECyT12"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 12 "JOSE MARIA MORELOS Y PAVON"',
    "CECyT13"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 13 "RICARDO FLORES MAGON"',
    "CECyT14"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 14 "LUIS ENRIQUE ERRO SOLER"',
    "CECyT15"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 15 "DIODORO ANTUNEZ ECHEGARAY"',
    "CECyT16"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 16 "HIDALGO"',
    "CECyT17"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 17 "LEON GUANAJUATO"',
    "CECyT18"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 18 "ZACATECAS"',
    "CECyT19"      => 'CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS No. 19 "LEONA VICARIO"',
    # Centros de Estudios Tecnológicos
    "CET1"         => 'CENTRO DE ESTUDIOS TECNOLOGICOS No. 1 "WALTER CROSS BUCHANAN"',
    "CESMT"        => "CENTRO DE ESTUDIOS SUPERIORES DE MARTINEZ DE LA TORRE, S.C.",
    "CETUG"        => "CENTRO DE ESTUDIOS TECNOLOGICOS Y UNIVERSITARIOS DEL GOLFO",
    "CICIMAR"      => "CENTRO INTERDISCIPLINARIO DE CIENCIAS MARINAS",
    "CLAES"        => "CENTRO LATINOAMERICANO DE ESTUDIOS SUPERIORES",
    # Centros Universitarios Grupo Sol
    "CUD"          => "CENTRO UNIVERSITARIO DORADOS",
    "CUGSCU"       => "CENTRO UNIVERSITARIO GRUPO SOL, CAMPUS CUAUHTEMOC",
    "CUGSCE"       => "CENTRO UNIVERSITARIO GRUPO SOL, CEM, S.C. PLANTEL SANTO TOMAS",
    "CUGSCH"       => "CENTRO UNIVERSITARIO GRUPO SOL, PLANTEL CHALCO",
    "CEFARHU"      => "CENTRO DE FORMACION Y APROVECHAMIENTO DEL RECURSO HUMANO, S.C., CAMPUS NEZAHUALCOYOTL",
    # Institutos y otras instituciones
    "DIF"          => "DIF DE ENFERMERIA, A.C.,",
    "EBC"          => "ESCUELA BANCARIA Y COMERCIAL",
    "ETZU"         => "ESCUELA TECNOLOGICA DE ZUMPANGO, A.C.",
    "ILBC"         => "INSTITUTO LEONARDO BRAVO, A.C.",
    "IBPU"         => "INSTITUTO BRITANICO DE LA CIUDAD DE PUEBLA",
    "IESCA"        => "INSTITUTO DE ENSEÑANZA SUPERIOR EN CONTADURIA Y ADMINISTRACION, S.C.",
    "IESHDL"       => 'INSTITUTO DE ESTUDIOS SUPERIORES "HIDALGO"',
    "ITSV"         => "INSTITUTO DE TURISMO STUDIO VIAJES, A.C.",
    "IESCAGJ"      => 'INSTITUTO ESPECIALIZADO EN COMPUTACION Y ADMINISTRACION "GAUSS JORDAN", A.C.',
    # NOTA: En el código original "ILBRAZA" estaba duplicado, mapeando a dos escuelas distintas.
    # El segundo bloque nunca se ejecutaba. Se corrige aquí con códigos distintos:
    "ILBRAZA"      => "INSTITUTO LEONARDO BRAVO, A.C., PLANTEL LA RAZA",
    "ILBRVE"       => "INSTITUTO LEONARDO BRAVO, A.C., PLANTEL VERACRUZ", # ← bug corregido
    "IMEPIZ"       => "INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL IZTAPALAPA",
    "IMEPSTM"      => "INSTITUTO MEXICANO DE EDUCACION PROFESIONAL, PLANTEL SANTA MARTHA",
    "ISECO"        => "INSTITUTO SUPERIOR DE ESTUDIOS COMERCIALES",
    "ITPP"         => "INSTITUTO TECNICO PROFESIONAL PANAMERICANO",
    "ITBSC"        => 'INSTITUTO TECNICO Y BANCARIO, "SAN CARLOS"',
    "ITESS"        => "INSTITUTO TECNOLOGICO DE ESTUDIOS SUPERIORES DEL SURESTE, A.C.",
    "IMCN"         => "INSTITUTO MEXICANO DE CERTIFICACIÓN Y NORMAS, S.C.",
    # Universidades
    "UARKOS"       => "UNIVERSIDAD ARKOS",
    "UCELAYA"      => "UNIVERSIDAD DE CELAYA",
    "UFLP"         => "UNIVERSIDAD FRAY LUCA PACCIOLI",
    "ISECVALLE"    => "UNIVERSIDAD ISEC, PLANTEL DEL VALLE",
    "UPI"          => "UNIVERSIDAD PRIVADA DE IRAPUATO",
    "UTCMCELAYA"   => "UNIVERSIDAD TECNOLOGICA DEL CENTRO DE MEXICO, CAMPUS CELAYA",
    "UTSCAMPE"     => "UNIVERSIDAD TECNOLOGICA DEL SURESTE, S.C., PLANTEL CAMPECHE",
    "UTSCOATZ"     => "UNIVERSIDAD TECNOLOGICA DEL SURESTE, S.C., PLANTEL COATZACOALCOS",
    "UTI"          => "UNIVERSIDAD TECNOLOGICA INTERNACIONAL",
    "UTM"          => "UNIVERSIDAD TECNOLOGICA MESOAMERICANA, S.C.",
    "CESEEO"       => "CENTRO DE ESTUDIOS SUPERIORES Y DE ESPECIALIDADES DEL ESTADO DE OAXACA",
  }.freeze
